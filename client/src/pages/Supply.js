    ...
    <div>
      ...
      <div class="container">
        ...
        <p>
          ...
          Exporter/Seller Send DDC &#8611; Payment Settlement &#8611;
          Confirmation
        </p>
        ...
        <br />
        <h5 className="btn btn-outline-dark  border-spacing: 5px">
          Step 1 &#8611; Issuing TF/DLC | Only a Registered Party,
          Buyer/Importer/Bank, can Perform this Step
        </h5>
        ...
        <br />
        <h5 className="btn btn-outline-dark  border-spacing: 5px">
          Step 2 &#8611; Shipment | Only a Registered Logistics and Shipment
          Provider can Perform this Step
        </h5>
        ...
        <br />
        <h5 className="btn btn-outline-dark  border-spacing: 5px">
          Step 3 &#8611; Seller/Exporter | Only a registered Exporter/Seller can
          Perform this Step
        </h5>
        ...
        <br />
        <h5 className="btn btn-outline-dark  border-spacing: 5px">
          Step 4 &#8611; Payment Settlement | Only a Registered,
          Buyer/Importer/Issuing Bank, can Perform this step
        </h5>
        ...
        <br />
        <h5 className="btn btn-outline-dark  border-spacing: 5px">
          Step 5 &#8611; Confirm as Done | Only a Registered Party can Perform
          this step
        </h5>
